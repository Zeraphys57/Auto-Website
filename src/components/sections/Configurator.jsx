          ...
          <div ref={panelRef}>
              ...
              <div className="flex gap-2">
                {VARIANTS.map((vr, i) => (
                  <button
                    ...
                    className={`flex-1 border px-4 py-3 font-display text-xl tracking-wide transition-all duration-300 ease-out hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-carbon ${
                      variant === i
              ...
              <div className="flex gap-2">
                {WHEELS.map((w, i) => (
                  <button
                    ...
                    onClick={() => setWheel(i)}
                    className={`flex-1 border px-3 py-2.5 font-accent text-caption uppercase tracking-wide-caps transition-all duration-300 ease-out hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-carbon ${
                      wheel === i
                        ? 'border-electric bg-electric/10 text-chrome'
                        : 'border-white/10 text-muted hover:border-white/30 hover:text-chrome'
                    }`}
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                ...
                data-cursor="cta"
                className="bg-electric px-7 py-3.5 transition-all duration-300 ease-out hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-carbon"
              >
