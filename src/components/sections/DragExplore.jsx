        ...
        >
          ...
          {HOTSPOTS.map((h) => (
            <button
              ...
              className="group absolute z-20 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ease-out hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-carbon rounded-full"
          ...
          <div className="absolute bottom-5 right-5 flex gap-2">
            <button type="button" data-cursor="hover" aria-label="Rotate left" onClick={() => nudge(-1)}
              className="flex h-9 w-9 items-center justify-center border border-white/15 text-chrome/70 transition-all duration-300 ease-out hover:border-electric hover:text-electric hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-carbon">
              ←
            </button>
