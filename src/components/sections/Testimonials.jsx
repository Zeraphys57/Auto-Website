        ...
        <div className="mt-12 flex items-center justify-center gap-3">
          {DATA.map((_, i) => (
            <button
              ...
              onClick={() => setIndex(i)}
              className="h-1.5 rounded-full transition-all duration-500 hover:scale-110 outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-carbon"
              style={{
                width: i === index ? 28 : 8,
